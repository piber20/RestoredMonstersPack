...
ImGui.AddCallback("rmRestoredMonstersWindow", ImGuiCallback.Render, function()
    ImGui.UpdateData("rmRestoredMonstersTabVesselType", ImGuiData.Value, mod.vesselType - 1)
    ImGui.UpdateData("rmRestoredMonstersTabBlindBatScream", ImGuiData.Value, mod.blindBatScreamInc)
end)